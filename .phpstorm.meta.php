...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Http\Repositories\MembershipRepositoryInterface' => \App\Http\Repositories\Impl\MembershipRepository::class,
            'App\Http\Repositories\OrganizationRepositoryInterface' => \App\Http\Repositories\Impl\OrganizationRepository::class,
            'App\Http\Repositories\PlanRepositoryInterface' => \App\Http\Repositories\Impl\PlanRepository::class,
            'App\Http\Repositories\UserRepositoryInterface' => \App\Http\Repositories\Impl\UserRepository::class,
            'App\Http\Services\MembershipServiceInterface' => \App\Http\Services\Impl\MembershipService::class,
            'App\Http\Services\UserServiceInterface' => \App\Http\Services\Impl\UserService::class,
            ...
            'Filament\Http\Responses\Auth\Contracts\LoginResponse' => \App\Filament\Http\Responses\Auth\LoginResponse::class,
            'Filament\Http\Responses\Auth\Contracts\LogoutResponse' => \App\Filament\Http\Responses\Auth\LogoutResponse::class,
    ...
    override(\config(), map([
            ...
            'data.casts.Brick\Math\BigDecimal' => 'string',
            ...
            'filesystems.links.C:\Users\illia\php-workspace\pass-pilot\public\storage' => 'string',
...
'data.casts.DateTimeInterface','data.casts.BackedEnum','data.casts.Brick\\Math\\BigDecimal','data.rule_inferrers','data.normalizers',
...
'filesystems.disks.minio.driver','filesystems.disks.minio.key','filesystems.disks.minio.secret','filesystems.disks.minio.region','filesystems.disks.minio.bucket',
'filesystems.disks.minio.url','filesystems.disks.minio.endpoint','filesystems.disks.minio.use_path_style_endpoint','filesystems.disks.minio.throw','filesystems.links.C:\\Users\\illia\\php-workspace\\pass-pilot\\public\\storage',
...
'filament.assets_path','filament.cache_path','filament.livewire_loading_delay','livewire.class_namespace','livewire.view_path',
...
'livewire.pagination_theme','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver','structure-discoverer.cache.store',
...
'filament.exports.download','filament.imports.failed-rows.download','filament.organization.auth.login','filament.organization.auth.logout','filament.organization.pages.dashboard',
'filament.organization.pages.my-profile','filament.organization.resources.venues.index','filament.organization.resources.plans.index','filament.organization.resources.memberships.index','filament.organization.tenant',
'filament.merchant.auth.login','filament.merchant.auth.register','filament.merchant.auth.logout','filament.merchant.pages.merchant-dashboard','filament.merchant.pages.my-profile',
'filament.organization.auth.two-factor','filament.merchant.auth.two-factor','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','storage.local',);
        registerArgumentsSet('views', 
'filament-breezy::components.clipboard-link','filament-breezy::components.grid-section','filament-breezy::filament.pages.my-profile','filament-breezy::filament.pages.two-factor','filament-breezy::livewire.personal-info',
'filament-breezy::livewire.sanctum-tokens','filament-breezy::livewire.two-factor-authentication','filament-breezy::livewire.update-password','filament.pages.merchant-dashboard','vendor.filament-breezy.components.clipboard-link',
'vendor.filament-breezy.components.grid-section','vendor.filament-breezy.filament.pages.my-profile','vendor.filament-breezy.filament.pages.two-factor','vendor.filament-breezy.livewire.personal-info','vendor.filament-breezy.livewire.sanctum-tokens',
'vendor.filament-breezy.livewire.two-factor-authentication','vendor.filament-breezy.livewire.update-password','welcome','filament-actions::badge-action','filament-actions::badge-group',
...
'filament-actions::link-action','filament-actions::link-group','filament-actions::select-action','filament-breezy::components.clipboard-link','filament-breezy::components.grid-section',
'filament-breezy::filament.pages.my-profile','filament-breezy::filament.pages.two-factor','filament-breezy::livewire.personal-info','filament-breezy::livewire.sanctum-tokens','filament-breezy::livewire.two-factor-authentication',
'filament-breezy::livewire.update-password','filament-forms::component-container','filament-forms::components.actions','filament-forms::components.actions.action-container','filament-forms::components.builder',
...
'filament-tables::table.sorting.fields.column.label','filament-tables::table.sorting.fields.direction.label','filament-tables::table.sorting.fields.direction.options.asc','filament-tables::table.sorting.fields.direction.options.desc','filament-breezy::default.password_confirm.heading',
'filament-breezy::default.password_confirm.description','filament-breezy::default.password_confirm.current_password','filament-breezy::default.two_factor.heading','filament-breezy::default.two_factor.description','filament-breezy::default.two_factor.code_placeholder',
'filament-breezy::default.two_factor.recovery.heading','filament-breezy::default.two_factor.recovery.description','filament-breezy::default.two_factor.recovery_code_placeholder','filament-breezy::default.two_factor.recovery_code_text','filament-breezy::default.two_factor.recovery_code_link',
'filament-breezy::default.two_factor.back_to_login_link','filament-breezy::default.profile.account','filament-breezy::default.profile.profile','filament-breezy::default.profile.my_profile','filament-breezy::default.profile.subheading',
'filament-breezy::default.profile.personal_info.heading','filament-breezy::default.profile.personal_info.subheading','filament-breezy::default.profile.personal_info.submit.label','filament-breezy::default.profile.personal_info.notify','filament-breezy::default.profile.password.heading',
'filament-breezy::default.profile.password.subheading','filament-breezy::default.profile.password.submit.label','filament-breezy::default.profile.password.notify','filament-breezy::default.profile.2fa.title','filament-breezy::default.profile.2fa.description',
'filament-breezy::default.profile.2fa.actions.enable','filament-breezy::default.profile.2fa.actions.regenerate_codes','filament-breezy::default.profile.2fa.actions.disable','filament-breezy::default.profile.2fa.actions.confirm_finish','filament-breezy::default.profile.2fa.actions.cancel_setup',
'filament-breezy::default.profile.2fa.setup_key','filament-breezy::default.profile.2fa.must_enable','filament-breezy::default.profile.2fa.not_enabled.title','filament-breezy::default.profile.2fa.not_enabled.description','filament-breezy::default.profile.2fa.finish_enabling.title',
'filament-breezy::default.profile.2fa.finish_enabling.description','filament-breezy::default.profile.2fa.enabled.notify','filament-breezy::default.profile.2fa.enabled.title','filament-breezy::default.profile.2fa.enabled.description','filament-breezy::default.profile.2fa.enabled.store_codes',
'filament-breezy::default.profile.2fa.disabling.notify','filament-breezy::default.profile.2fa.regenerate_codes.notify','filament-breezy::default.profile.2fa.confirmation.success_notification','filament-breezy::default.profile.2fa.confirmation.invalid_code','filament-breezy::default.profile.sanctum.title',
'filament-breezy::default.profile.sanctum.description','filament-breezy::default.profile.sanctum.create.notify','filament-breezy::default.profile.sanctum.create.message','filament-breezy::default.profile.sanctum.create.submit.label','filament-breezy::default.profile.sanctum.update.notify',
'filament-breezy::default.profile.sanctum.update.submit.label','filament-breezy::default.profile.sanctum.copied.label','filament-breezy::default.clipboard.link','filament-breezy::default.clipboard.tooltip','filament-breezy::default.fields.avatar',
'filament-breezy::default.fields.email','filament-breezy::default.fields.login','filament-breezy::default.fields.name','filament-breezy::default.fields.password','filament-breezy::default.fields.password_confirm',
'filament-breezy::default.fields.new_password','filament-breezy::default.fields.new_password_confirmation','filament-breezy::default.fields.token_name','filament-breezy::default.fields.token_expiry','filament-breezy::default.fields.abilities',
'filament-breezy::default.fields.2fa_code','filament-breezy::default.fields.2fa_recovery_code','filament-breezy::default.fields.created','filament-breezy::default.fields.expires','filament-breezy::default.or',
'filament-breezy::default.cancel',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','MINIO_ACCESS_KEY_ID','MINIO_SECRET_ACCESS_KEY',
'MINIO_DEFAULT_REGION','MINIO_BUCKET','MINIO_URL','MINIO_ENDPOINT','MINIO_USE_PATH_STYLE_ENDPOINT',
'VITE_APP_NAME','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET',);
